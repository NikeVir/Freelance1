...
interface HeroContainer {
  ...
  const HomeContentHero:HeroContainer = {
    ...
    description: "Utilize proxies to enhance and streamline your market research efforts, ensuring comprehensive insights and improved data accuracy for informed business decisions.",
    points:["Efficient data gathering","Enhanced data accuracy and reliability","Targeted audience profiling"],
    pointsColor: "purple",
...
const Data: DataItem[] = [
    {
        ...
        description: "Utilize proxies to gather and analyze data from reviews, forums, social media, and search keywords. This allows for enhanced audience understanding, refined marketing strategies, and the identification of new business opportunities. Advanced filtering methods with extensive data also help analyze competitors and identify influencers in your industry.",
        color: 'primary',
        direction: "left"
    },
    {
        ...
        description: "Use proxies to analyze market data for refining product features and pricing strategies. This helps ensure your products meet customer needs effectively and are competitively priced, enhancing overall market success.",
        color: 'primary',
        direction: "right"
