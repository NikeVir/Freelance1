...
const Data: DataItem[] = [
    {
        ...
        description: "Utilize proxies to access geo-specific product information from major e-commerce platforms worldwide. Proxies facilitate the collection of detailed product data tailored to specific countries, states, or cities, ensuring you obtain the most pertinent and localized information for your business needs.",
        color: 'primary',
        direction: "left"
    },
    {
        ...
        description: "Ensure uninterrupted access to essential data by using proxies to circumvent anti-bot measures implemented by many e-commerce sites. Proxies effectively bypass IP bans and CAPTCHA challenges, enabling seamless retrieval of critical information without interruptions.",
        color: 'primary',
        direction: "right"
    ...
    },
    {
        ...
        description: "Streamline your data collection process with proxies, ensuring instant access to structured, analysis-ready e-commerce data. By obtaining ready-to-use information, you eliminate the tedious tasks of data cleaning and organization, allowing you to focus on strategic analysis and informed decision-making",
        color: 'primary',
        direction: "left"
    },
];
