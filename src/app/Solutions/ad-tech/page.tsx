...
interface HeroContainer {
  ...
  const HomeContentHero:HeroContainer = {
    ...
    description: "Enhance advertising technology with proxies for efficient campaign management.",
    points:["Optimize ad targeting and performance metrics","Ensure reliable and secure ad placement across platforms","Manage campaigns efficiently"],
    pointsColor: "green",
...
const Data: DataItem[] = [
  {
      ...
      description: "Enhance your global advertising reach with proxies that bypass geo restrictions. Access worldwide locations to optimize engagement and effectively target diverse markets, ensuring your ads reach the right audiences across borders with precision",
      color: 'primary',
      direction: "left"
  },
  {
      ...
      description: "Ensure uninterrupted ad verification ,eliminating IP blocking risks. Rotate IP addresses seamlessly to evade fraudsters and maintain a smooth verification process. This approach supports continuous operations and scalability, enabling ad monitoring companies to focus on business growth without disruptions.",
      color: 'primary',
      direction: "right"
  ...
  },
  {
      ...
      description: "Protect your brand with comprehensive monitoring. Track copyright, domain name abuse, and misuse of branded content in real-time. Monitor unlawful competitor activities accurately to prevent misinformation derived from your IP address.",
      color: 'primary',
      direction: "left"
  },
];
