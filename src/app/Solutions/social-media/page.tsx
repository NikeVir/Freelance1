...
interface HeroContainer {
  ...
  const HomeContentHero:HeroContainer = {
    ...
    points:["Elevate your industry's social media presence","Anticipate emerging trends","Gain real-time insights"],
    pointsColor: "green",
...
const Data: DataItem[] = [
    {
        ...
        description: "Use proxies to expand your audience reach anonymously across different online platforms. This helps you execute targeted marketing effectively, ensuring you comply with regulations and build credibility with your audience.",
        color: 'primary',
        direction: "left"
    },
    {
        ...
        description: "Analyze customer behavior across platforms to predict trends and personalize customer experiences. Track sentiments and competitor perceptions through diverse data sources, filtering by keywords and other parameters for targeted insights",
        color: 'primary',
        direction: "right"
    ...
    },
    {
        ...
        title: 'Understand Customer Behavior and Predict Trends',
        description: "Enhance marketing budget efficiency by simplifying market research, analyzing competition, and effectively targeting your audience. This optimization maximizes the impact of your campaigns, ensuring resources are allocated strategically for optimal results.",
        color: 'primary',
        direction: "left"
    },
];
