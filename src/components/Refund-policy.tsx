  ...
  return (
    <section className="pb-16 overflow-hidden bg-white">
      <div className="flex flex-col justify-center items-center space-y-12">
        <Image src="/images/illustration/single-cat.svg" alt="" className="mt-16 w-full max-w-xs mx-auto" height={400} width={400} />
        ...
        <div className="text-[24px] sm:text-[24px] p-4 sm:p-16 flex flex-col justify-center items-center text-center sm:items-start sm:text-left text-gray-500 font-normal space-y-4">
          ...
          <p>
            ...
            there may be exceptional circumstances where a refund is necessary.
            If you encounter any problems that you believe require serious
            attention, please contact our support team immediately.
          </p>
          ...
          <p>
            ...
            please contact us within 24 hours of the transaction to resolve the
            issue.
          </p>
          ...
          <p>
            ...
            support@catproxies.com with your order details and a description of
            the issue you are experiencing.
          </p>
          <p>
            Provide Documentation: Be prepared to provide any relevant
            documentation or evidence to support your claim (e.g., screenshots,
            error messages).
          </p>
          <p>
            Submit within 24 Hours: All refund requests must be submitted within
            24 hours of purchase. Requests received after this period may not be
            considered.
          </p>
          ...
          <p>
            ...
            business days for the refund to appear on your account, depending on
