            ...
            <div className="px-4">
              <div className="max-w-2xl mx-auto lg:mx-0 lg:flex-auto">
                ...
                <span className="flex items-center justify-center gap-x-1">
                    <img src="/images/icons/single-star.svg" className="w-5 h-5 " />
                    <p className="mt-1 font-medium text-gray-900">Trustpilot</p>
                    <img src="/images/icons/five-stars.svg" alt="" className="mt-1"/>
                  </span>
                ...
                <div className="flex flex-col items-center gap-6 mt-10 sm:flex-row ">
                  ...
                  >
                    <img src="/images/icons/google-icon.svg" alt="" /> Sign up with
                    Google
                  </a>
                </div>
                <div className="flex items-center gap-4 mt-10">
                  ...
                  <p className="inline-flex items-center gap-4 text-base text-gray-600">
                    <img src="/images/icons/tick.svg" alt="" /> 3-day money-back option
                  </p>
