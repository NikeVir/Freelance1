        ...
        <div className="mt-10 lg:grid lg:grid-cols-12 lg:gap-8">
          <div className="lg:col-span-5 space-y-4 text-center lg:text-left">
            ...
            <p className="flex-col max-w-xl mx-auto mt-4 text-base text-secondary/80">
              <span style={{color: '#525252', fontFamily: 'Sora', fontSize: '24px', fontWeight: '400'}}>Explore How Our Expertise Translates</span> <span style={{color: '#525252', fontFamily: 'Sora', fontSize: '24px', fontWeight: '400'}}>into Tangible Results.</span>
            </p>
