      ...
      <div className="flex flex-col justify-center items-center space-y-12">
        ...
        <div className="text-[24px] p-16 flex flex-col justify-left items-left text-gray-500 font-normal space-y-3">
          ...
          <p>
            ...
            function properly. They enable you to navigate our site and use its
            features.
          </p>
          <p>
          ...
          <p>
            ...
            advertisements relevant to you and your interests. They also help us
          ...
          <p>
            ...
            our website. For example, we use third-party analytics services that
          ...
          <p>
            ...
            analyze the use of our website. These third parties may set cookies
            on your device to collect information about your online activities
          ...
          <p>
            Browser Settings: Most web browsers allow you to manage your cookie
            preferences through the browser settings. You can set your browser
            to block or delete cookies. However, please note that if you disable
