      ...
      <div className="flex flex-col justify-center items-center space-y-12">
        ...
        <div className="text-[24px] p-16 flex flex-col justify-left items-left text-gray-500 font-normal space-y-3">
          ...
          <p>
            ...
            purchase, the proxy credentials will be available for immediate use,
            or within 60 minutes/hours, depending on the service purchased.
          </p>
          ...
          <p>
            Most of our proxy services are available instantly after the payment
            is confirmed. You will receive an email notification with access
            details, and the services will be accessible via your account
            dashboard.
          </p>
          ...
          <p>
            ...
            verification requirements. Typically, this delay will not exceed 48
            hours. You will be notified via email in case of any delays.
          </p>
          ...
          <p>
            Our proxy services are designed to be available 24/7. However, there
            may be periods of downtime for maintenance or unforeseen technical
            issues. We strive to minimize any disruptions and will notify you in
            advance whenever possible.
          </p>

          <p>8. Lost or Compromised Credentials</p>
          <p>
            If you believe your proxy credentials have been lost or compromised,
            please contact our support team immediately at
            support@catproxies.com. We will close all plans of the old account
            and assist you in securing a new account. In certain cases, we might
            be able to transfer some of your plans to a new account.
          </p>

          <p>9. Changes to Delivery Details</p>
          <p>
            If you need to change any details related to your proxy service
            delivery, such as updating your contact email, please contact us as
            soon as possible at support@catproxies.com. We will do our best to
          ...
          <p>
            ...
            purchase process. We are not responsible for any issues arising from
            incorrect information provided by the customer.
          </p>

          <p>10.2 Compliance</p>
          <p>
            You are responsible for ensuring that your use of our proxy services
