  ...
  return (
    <section className="pb-16 overflow-hidden bg-white">
      <div className="flex flex-col justify-center items-center space-y-12">
        <Image src="/images/illustration/single-cat.svg" alt="Illustration of a single cat" className="mt-16 w-full max-w-xs mx-auto" height={400} width={400}/>
        ...
        <div className="text-[24px] sm:text-[24px] p-4 sm:p-16 flex flex-col justify-center items-center text-center sm:items-start sm:text-left text-gray-500 font-normal space-y-4">
          ...
          <p>
            When you register for an account, purchase our services, or contact
            us, we may collect the following personal information:
          </p>
          <p>Email address</p>
          ...
          <p>
            To communicate with you, including sending updates, security alerts,
          ...
          <p>
            Data Portability: You have the right to request that we transfer the
